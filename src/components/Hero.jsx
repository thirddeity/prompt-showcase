    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <h1
            className="font-display font-extrabold leading-none tracking-tighter blur-[2px] opacity-50"
            style={{
              color: '#F0FDF4',
          ...
          <p
            className="mt-4 md:mt-6 text-sm md:text-lg font-body max-w-md mx-auto"
            style={{ color: '#4D7C76' }}
          >
      ...
      >
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #0F2523 0%, #0a1a18 100%)' }}
        />
      ...
      <div className="absolute bottom-6 md:bottom-10 left-0 right-0 z-10 px-[8vw]">
        ...
        >
          <div>
            <h2
              className="text-xs md:text-base tracking-[0.3em] uppercase font-mono mb-1"
              style={{ color: '#F0FDF4' }}
            >
